...
#ifndef _GST_MYSINK_H_
#define _GST_MYSINK_H_
...
#define GST_IS_MYSINK_CLASS(obj)   (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_MYSINK))
...
struct _GstMysink
{
  GstBaseSink base_mysink;

};

struct _GstMysinkClass
{
  GstBaseSinkClass base_mysink_class;
};
